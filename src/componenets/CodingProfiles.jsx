...
function CodingProfiles() {
  return (
    <div className="container px-4 py-5" id="custom-cards">
      ...
      <h5 >My graphic designer friend left me on read, so my cards will have no background images. It's minimalism at its finest, or as I call it,<span style={{color:"#0d6efd"}}> "unintended genius."</span> But hey, my coding profiles are still top-notch🔥</h5>
